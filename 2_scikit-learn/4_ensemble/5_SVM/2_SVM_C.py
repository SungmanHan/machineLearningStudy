...
svc_model = SVC(random_state=1,C=1.0,gamma=1).fit(X_train,y_train)

print('학습 평가 : ',svc_model.score(X_train,y_train))
print('테스트 평가 : ',svc_model.score(X_test,y_test))

from sklearn.svm import LinearSVC
lr_model = LinearSVC(C=1).fit(X_train,y_train)

print('학습 평가 : ',lr_model.score(X_train,y_train))
print('테스트 평가 : ',lr_model.score(X_test,y_test))